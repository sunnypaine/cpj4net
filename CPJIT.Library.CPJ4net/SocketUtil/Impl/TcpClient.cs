    ...
    public class TcpClient : ITcpClient, IDisposable
    {
        ...
        private void ConnectCallback(IAsyncResult iar)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    this.OnException(this, new ExceptionEventArgs() { Exception = new Exception("连接服务端出错", ex) });
                }
            }
        }
        ...
        private void ReceiveDataCallback(IAsyncResult iar)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    this.OnException(this, new ExceptionEventArgs() { Exception = new Exception("接收数据出错", ex) });
                }
            }
        }
        ...
        public TcpClient Connect()
        {
            if (this.IsConnect == false)
            {
                if (this.ServerIpAddress == null)
                {
                    ...
                    {
                        this.OnException(this, new ExceptionEventArgs() { Exception = new ArgumentNullException("服务端IP不合法。") });
                        return null;
                    }
                }
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        this.OnException(this, new ExceptionEventArgs() { Exception = new Exception("初始化客户端出错。", ex) });
                        return null;
                    }
                }
            }
        ...
        public void Send(string message)
        {
            ...
            catch (Exception ex)
            {
                if (this.OnException != null)
                {
                    this.OnException(this, new ExceptionEventArgs() { Exception = new Exception("发送消息出错。", ex) });
                }
            }
        }
        ...
        public void Send(byte[] data)
        {
            if (data == null)
            {
                ...
                {
                    this.OnException(this, new ExceptionEventArgs() { Exception = new ArgumentNullException("发送的内容不能为null。") });
                }
            }
